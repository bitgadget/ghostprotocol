...
import { Bundle, BundleTier, Language } from '../types';
...
export const BundleCard: React.FC<BundleCardProps> = ({ bundle, onAddToCart, lang = 'it' }) => {
      ...
      >
        ...
        <div className="bg-cyber-alert text-black font-bold font-mono text-xs py-1 overflow-hidden relative z-30">
          <div className="animate-marquee whitespace-nowrap">
             {lang === 'it' 
                ? "ATTENZIONE: LIVELLO SICUREZZA 4 RICHIESTO // TOP SECRET // PROTOCOLLO FANTASMA ATTIVO // NON RICONOSCERE L'ESISTENZA" 
                : "WARNING: LEVEL 4 CLEARANCE REQUIRED // TOP SECRET // EYES ONLY // GHOST PROTOCOL ACTIVE // DO NOT ACKNOWLEDGE EXISTENCE"}
          </div>
        </div>
        ...
        <div className="p-8 lg:p-12 relative z-10 grid grid-cols-1 lg:grid-cols-3 gap-8 items-center">
          ...
          <div className="flex flex-col items-center justify-center lg:pl-8 border-l-0 lg:border-l border-cyber-alert/30 h-full">
              <div className="text-center mb-8">
                 <p className="text-cyber-alert text-sm mb-1">{t.bundle_cost}</p>
    ...
    >
      ...
      <div className="flex-grow mb-8">
        <h4 className="text-xs font-bold text-white mb-3 uppercase tracking-wider flex items-center gap-2">
            <Package size={14} className="text-cyber-dim"/> Equip
        </h4>
        ...
        <h4 className="text-xs font-bold text-white mb-3 uppercase tracking-wider flex items-center gap-2">
            <Radio size={14} className="text-cyber-dim"/> Cap
        </h4>
        <motion.ul 
      ...
      <div className="mt-auto pt-6 border-t border-cyber-dim/20 flex flex-col gap-4">
         <div className="flex justify-between items-end">
            <span className="text-xs text-gray-500 font-mono">COST</span>
