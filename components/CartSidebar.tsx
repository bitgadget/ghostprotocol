          ...
          >
            ...
            <div className="p-6 border-b border-cyber-dim/30 flex justify-between items-center bg-cyber-dark/50">
              <div className="flex items-center gap-3 text-cyber-green">
                ...
                <h2 className="text-xl font-mono font-bold tracking-widest">SECURE_CART</h2>
              </div>
              <button 
                onClick={onClose}
                className="text-gray-400 hover:text-cyber-alert transition-colors"
              >
                <X />
              </button>
            </div>
            ...
            <div className="flex-1 overflow-y-auto p-6 space-y-4 scrollbar-thin">
              {items.length === 0 ? (
                <div className="h-full flex flex-col items-center justify-center text-cyber-dim opacity-50 space-y-4">
                  ...
                  <p className="font-mono text-lg">NO ASSETS DETECTED</p>
                </div>
              ) : (
                items.map((item) => (
                  <motion.div 
                      ...
                      <div>
                        <div className="flex justify-between items-start mb-1">
                          ...
                          <button 
                            ...
                            className="text-cyber-dim hover:text-cyber-alert transition-colors p-1"
                          >
                            <Trash2 size={16} />
                          </button>
                        </div>
            ...
            <div className="p-6 border-t border-cyber-dim/30 bg-black/90 space-y-4">
              <div className="space-y-2 font-mono text-sm">
                ...
                <div className="flex justify-between text-gray-400">
                  ...
                  <span className="text-cyber-green">INCLUDED</span>
                </div>
                <div className="flex justify-between text-xl text-white font-bold pt-2 border-t border-cyber-dim/20">
                  <span>TOTAL</span>
                  <span>€{total.toFixed(2)}</span>
                </div>
              </div>
              ...
              <div className="text-center">
                <span className="text-[10px] text-cyber-dim flex items-center justify-center gap-1">
                   <ShieldCheck size={10} /> 
                   SECURE SSL CONNECTION // NO LOGS KEPT
                </span>
              </div>
            </div>
          </motion.div>
